...
--     );
--
-- -- DROP INDEX  idx_title ON inventory;
-- -- CREATE INDEX idx_title ON inventory (title);
-- --
-- -- DROP INDEX  idx_author ON inventory;
-- -- CREATE INDEX idx_author ON inventory (author);
-- --
-- -- DROP INDEX idx_genre_id ON inventory;
...
--                           AND index_name = 'idx_author');
--
-- IF @idx_author_exists > 0 THEN
-- ALTER TABLE inventory DROP INDEX idx_author;
-- END IF;
--
...
-- INSERT INTO inventory (id, title, author, genre_id, publication_date, isbn) VALUES
